...
public class RecyclerHyderabad extends RecyclerView.Adapter<RecyclerHyderabad.ViewHolder> {

    private String[] titles = {"Chapter Hyderabad One",
            "Chapter Hyderabad Two",
            "Chapter Hyderabad Three",
            "Chapter Hyderabad  Four",
            "Chapter Hyderabad Five",
            "Chapter Hyderabad Six",
            "Chapter Hyderabad Seven",
            "Chapter Hyderabad Eight"};
